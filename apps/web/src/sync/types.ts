...
// NOTE: State adapter functions (toSyncPlaybackState, fromSyncPlaybackState,
// toSyncQueueState, fromSyncQueueState, adjustPositionForClockDrift,
// createPlaybackState) have been moved to ./adapters.ts to separate
// type definitions from transformation logic.
